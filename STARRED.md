...
| -------------- | --------------- |
| **[google/magika](https://github.com/google/magika)** \| ⭐ *6.4K* | Detect file content types with deep learning
| **[astral-sh/uv](https://github.com/astral-sh/uv)** \| ⭐ *6.8K* | An extremely fast Python package installer and resolver, written in Rust.
| **[mitmath/18330](https://github.com/mitmath/18330)** \| ⭐ *331* | 18.330 Introduction to Numerical Analysis
| **[mitmath/18335](https://github.com/mitmath/18335)** \| ⭐ *463* | 18.335 - Introduction to Numerical Methods course
| **[mlabonne/llm-course](https://github.com/mlabonne/llm-course)** \| ⭐ *24.2K* | Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
| **[dangeng/visual_anagrams](https://github.com/dangeng/visual_anagrams)** \| ⭐ *670* | Code for the paper "Visual Anagrams: Generating Multi-View Optical Illusions with Diffusion Models"
...
| **[mlco2/impact](https://github.com/mlco2/impact)** \| ⭐ *173* | ML has an impact on the climate. But not all models are born equal. Compute your model's emissions with our calculator and add the results to your paper with our generated latex template
| **[ngnquanq/NLP_Final](https://github.com/ngnquanq/NLP_Final)** \| ⭐ *2* | NLP 
| **[ollama/ollama](https://github.com/ollama/ollama)** \| ⭐ *39.9K* | Get up and running with Llama 2, Mistral, Gemma, and other large language models.
...
| **[OpenLogicProject/OpenLogic](https://github.com/OpenLogicProject/OpenLogic)** \| ⭐ *966* | An open-source, customizable intermediate logic textbook
| **[bgavran/Category_Theory_Machine_Learning](https://github.com/bgavran/Category_Theory_Machine_Learning)** \| ⭐ *943* | List of papers studying machine learning through the lens of category theory
| **[hmemcpy/milewski-ctfp-pdf](https://github.com/hmemcpy/milewski-ctfp-pdf)** \| ⭐ *10.6K* | Bartosz Milewski's 'Category Theory for Programmers' unofficial PDF and LaTeX source
...
| **[astral-sh/ruff](https://github.com/astral-sh/ruff)** \| ⭐ *24.1K* | An extremely fast Python linter and code formatter, written in Rust.
